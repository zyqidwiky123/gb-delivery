      ...
      <main className="flex-grow p-8 md:p-12 overflow-y-auto">
        <header className="flex justify-between items-center mb-12">
            ...
            <div className="flex gap-4">
               <div className="bg-[#111] p-3 rounded-xl border border-on-background/5 text-xs font-bold text-zinc-400 uppercase tracking-widest px-6 flex items-center gap-2">
        ...
        <section className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 mb-12">
          {stats.map((stat, idx) => (
            <div key={idx} className="bg-[#111] p-8 rounded-[2.5rem] border border-on-background/5 shadow-2xl relative overflow-hidden group hover:border-primary/20 transition-all cursor-pointer">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
           <div className="lg:col-span-2 bg-[#111] p-8 rounded-[2.5rem] border border-on-background/5 shadow-xl relative overflow-hidden">
              ...
              <div className="space-y-4">
                 {[1, 2, 3].map(i => (
                   <div key={i} className="flex items-center justify-between p-5 bg-[#080808] rounded-3xl border border-on-background/5 hover:border-primary/20 transition-all">
                      <div className="flex items-center gap-4">
                         ...
                         <div>
                            <p className="text-sm font-bold text-on-background">ARO JEK - Perjalanan #4512</p>
           ...
           <div className="bg-gradient-to-br from-[#111] to-[#080808] p-8 rounded-[2.5rem] border border-on-background/5 shadow-xl flex flex-col justify-between">
              <div className="space-y-4">
              ...
              <div className="space-y-6 my-8">
                 <div className="bg-[#080808] p-4 rounded-2xl border border-on-background/5">
                    <p className="text-[10px] font-bold text-zinc-600 uppercase tracking-widest mb-1">Base Fare</p>
                    <p className="text-xl font-headline font-black text-on-background italic">Rp 10.000</p>
                 </div>
                 <div className="bg-[#080808] p-4 rounded-2xl border border-on-background/5">
                    <p className="text-[10px] font-bold text-zinc-600 uppercase tracking-widest mb-1">Rate / KM</p>
                    <p className="text-xl font-headline font-black text-on-background italic">Rp 2.500</p>
                 </div>
              </div>
